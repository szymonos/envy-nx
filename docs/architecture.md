...
Bash is not commonly thought of as a test-friendly language. This codebase has 676+ test cases across 37 test files because the architecture deliberately enables it.

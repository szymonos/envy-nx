...
Bash is not commonly thought of as a test-friendly language. This codebase has 650+ test cases across 35 test files because the architecture deliberately enables it.

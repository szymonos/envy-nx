...
Bash is not commonly thought of as a test-friendly language. This codebase has 665+ test cases across 36 test files because the architecture deliberately enables it.

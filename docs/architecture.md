...
Bash is not commonly thought of as a test-friendly language. This codebase has 600+ test cases across 33 test files because the architecture deliberately enables it.

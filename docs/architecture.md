...
Bash is not commonly thought of as a test-friendly language. This codebase has 400+ test cases across 22 test files because the architecture deliberately enables it.

...
| Metric                  | Value                                                                       |
| ----------------------- | --------------------------------------------------------------------------- |
| Unit tests              | Bats (bash) and Pester (PowerShell) suites across 41 test files             |
| Custom pre-commit hooks | 16 (bash 3.2 enforcer, scope validator, manifest-drift defenders, and more) |

...
.NOTES
# :save script example
.assets/scripts/scripts_egsave.ps1 wsl/wsl_systemd.ps1
# :override the existing script example if exists
.assets/scripts/scripts_egsave.ps1 wsl/wsl_systemd.ps1 -Force
# :open the example script in VSCode
code -r (.assets/scripts/scripts_egsave.ps1 wsl/wsl_systemd.ps1 -WriteOutput)
#>
[CmdletBinding()]
param (

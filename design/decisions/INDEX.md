...
| 0010 | lib.lowPrio for buildEnv collisions | `nix/flake.nix`, `nix/scopes/*.nix`                             | [0010](0010-lowprio-buildenv-collisions.md) |
| 0011 | CI-gated rolling nixpkgs revision   | `nix/nixpkgs_rev.json`, `.assets/lib/nx_rev.sh`, bump workflow  | [0011](0011-validated-nixpkgs-rev.md)       |
| 0012 | One upgrade path through setup.sh   | `nx_pkg.sh`, `nx_lifecycle.sh`, `nix/lib/phases/nix_profile.sh` | [0012](0012-one-upgrade-path.md)            |

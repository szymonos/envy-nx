...
function _nx_completions() {
  ...
  if [ "$COMP_CWORD" -eq 1 ]; then
    ...
    --remove)
      ...
      ;;
    *)
      while IFS= read -r line; do COMPREPLY+=("$line"); done < <(compgen -W "--az --bun --conda --docker --gcloud --k8s-base --k8s-dev --k8s-ext --nodejs --playwright --pwsh --python --rice --shell --terraform --zsh --all --latest --allow-unfree --unattended --register-ssh-key --skip-repo-update --update-modules --omp-theme --starship-theme --remove --help -h" -- "$cur")
      ;;
    esac

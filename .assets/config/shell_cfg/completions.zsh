...
function _nx() {
  ...
  subcmds=(
    ...
    'upgrade:update nx, upgrade packages to the validated nixpkgs revision, refresh shell profiles'
    'update:update nx, upgrade packages to the validated nixpkgs revision, refresh shell profiles'

...
$Module = 'do-win'
# *install
.assets/scripts/module_manage.ps1 $Module -CleanUp -Verbose
.assets/scripts/module_manage.ps1 $Module -CleanUp -Verbose -Scope CurrentUser
.assets/scripts/module_manage.ps1 $Module -CleanUp -Verbose -Force
.assets/scripts/module_manage.ps1 $Module -CleanUp -RemoveRequirements -Verbose
@('aliases-git', 'aliases-kubectl') | .assets/scripts/module_manage.ps1 -CleanUp -Verbose
# *delete module
.assets/scripts/module_manage.ps1 $Module -Delete -Verbose
# *scaffold module manifest
.assets/scripts/module_manage.ps1 -Module 'do-test' -Create -Verbose
#>

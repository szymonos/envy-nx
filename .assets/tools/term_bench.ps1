...
.NOTES
# :save script example
.assets/scripts/scripts_egsave.ps1 .assets/tools/term_bench.ps1
# :override the existing script example if exists
.assets/scripts/scripts_egsave.ps1 .assets/tools/term_bench.ps1 -Force
# :open the example script in VSCode
code -r (.assets/scripts/scripts_egsave.ps1 .assets/tools/term_bench.ps1 -WriteOutput)
#>
param (
    [int]$Iterations
)

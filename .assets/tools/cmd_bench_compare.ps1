...
.NOTES
# :save script example
.assets/scripts/scripts_egsave.ps1 .assets/tools/cmd_bench_compare.ps1
# :override the existing script example if exists
.assets/scripts/scripts_egsave.ps1 .assets/tools/cmd_bench_compare.ps1 -Force
# :open the example script in VSCode
code -r (.assets/scripts/scripts_egsave.ps1 .assets/tools/cmd_bench_compare.ps1 -WriteOutput)
#>

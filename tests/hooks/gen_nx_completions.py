...
# `compdef` is created by compinit; zsh ships no autoloadable `compdef` of its
# own, so the fallback below has to bootstrap compinit or there is no
# completion at all on a stock zsh.
ZSH_REGISTER = """\
